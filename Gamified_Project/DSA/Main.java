...
public class Main {
    ...
    private static void printFarewell(Student s) {
        ...
        System.out.println("╠══════════════════════════════════════════════════╣");
        System.out.printf( "║  Student  : %-36s║%n", s.name);
        System.out.printf( "║  Points   : %-36s║%n", s.points + " pts");
        System.out.printf( "║  Level    : %-36s║%n", s.level);
        System.out.printf( "║  Badge    : %-36s║%n", RewardSystem.getBadge(s.points));
        System.out.printf( "║  Rank     : %-36s║%n", RewardSystem.getRank(s.level));
        System.out.printf( "║  Streak   : %-36s║%n", s.streak + " tasks");
        System.out.println("╚══════════════════════════════════════════════════╝");
